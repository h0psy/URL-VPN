...
echo 11. ALT3 yoffset
echo 12. ALT3 HKCU
echo 13. ALT3 keyangle
echo 14. ALT3 n0
echo 15. ALT3 n2
echo _______________________________________________________________
echo 16. bypassing the block .com 1
echo 17. bypassing the block .com 2
echo _______________________________________________________________
echo 0. exit
echo.
...
if %var%==7 goto ALT3 a2a09b
if %var%==8 goto ALT3 real240
if %var%==9 goto ALT3 HKLM
if %var%==10 goto ALT3 a2a190b
if %var%==11 goto ALT3 yoffset
if %var%==12 goto ALT3 HKCU
if %var%==13 goto ALT3 keyangle
if %var%==14 goto ALT3 n0
if %var%==15 goto ALT3 n2
if %var%==16 goto bypassing the block .com 1
if %var%==17 goto bypassing the block .com 2
if %var%==0 goto exit
:start VPN
cls
echo[System.File]
